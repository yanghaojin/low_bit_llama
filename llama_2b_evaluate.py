...
model, tokenizer = load_llama_model(model_uri, cache_dir=cache_dir, groupsize=args.groupsize,
                                    double_groupsize=double_groupsize, bits=2, half=True, v1=v1, asym=asym,
                                    use_gbe=args.use_gbe)
model.eval()
